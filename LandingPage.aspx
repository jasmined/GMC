...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:HyperLink ID="HyperLink1" runat="server" BorderColor="#99CCFF" BorderStyle="Outset" ForeColor="#0000CC" NavigateUrl="WebForm1.aspx" Width="102px" ImageUrl="~/GMClogo.png">Enter GMC</asp:HyperLink>
        </div>
    </form>
